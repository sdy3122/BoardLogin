...
public class FrontController extends HttpServlet {
	...
	private void actionDo(HttpServletRequest request,HttpServletResponse response) {
		...
		if(command.equals("/login.do")) {//login 로그인
		...
		else if(command.equals("/main.do")) {//main 메인
		...
		else if(command.equals("/logout.do")) {//logout 로그아웃
		...
		else if(command.equals("/board.do")) {//board 게시판상세페이지로가기
		...
		else if(command.equals("/insert.do")) {//insert 글등록
		...
		else if(command.equals("/boardupdate.do")) {//boardupdate 글변경
